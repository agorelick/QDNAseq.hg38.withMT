#########################################################################/**
# @RdocFunction binReadCounts_withMT
#
...
# readCounts <- binReadCounts_withMT(bins)
# }
# }
#
# @author "IS,DS"
...
# @keyword file
#*/#########################################################################
binReadCounts_withMT <- function(bins, bamfiles=NULL, path=NULL, ext='bam',
    ...
    for (i in seq_along(bamfiles)) {
        ...
        if (!is.null(chunkSize)) {
            counts[, i] <- .binReadCountsPerChunk_withMT(bins=bins,
        ...
        counts[, i] <- .binReadCountsPerSample_withMT(bins=bins,
...
.binReadCountsPerChunk_withMT <- function(bins, bamfile, chunkSize, cache, force,
...
.binReadCountsPerSample_withMT <- function(bins, bamfile, cache, force,
    isPaired, isProperPair, isUnmappedQuery, hasUnmappedMate,
    isMinusStrand, isMateMinusStrand, isFirstMateRead, isSecondMateRead,
    isSecondaryAlignment, isNotPassingQualityControls, isDuplicate, minMapq) {
